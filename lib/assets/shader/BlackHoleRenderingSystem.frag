...
void main() {
    ...
    if (distToCenter > 0.5) {
        ...
        float blackHoleStrength = (0.5 - distToCenter) / 0.4;
        ...
        vec3 colorDiff = vec3(1.0, 1.0, 1.0) - texColor.rgb;
        gl_FragColor = vec4(texColor.rgb + colorDiff * blackHoleStrength * blackHoleStrength, 1.0);
    }
}