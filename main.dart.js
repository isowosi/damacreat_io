...
fn:function(a8,a9,b0,b1,b2,b3,b4,b5,b6,b7,b8){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3,a4,a5,a6,a7
if(b7===1){z=C.c.ay(24)
y=b6.a
x=y[z]
...
e=Math.cos(c)
b=F.dO(b2.a,b2.b,b2.c)
a=b[1]+0.1
b[1]=a
a0=b[2]+0.1
b[2]=a0
a1=F.f1(b[0],a,a0)
for(p=p+o*l*w-u,m=k+j*m*w-t,h=y+i*h*w-s,n=r+g*n*w-q,e=d/e*0.1,g=c-0.04908738521234052,r=[S.C],a2=0;a2<Math.sqrt(b0.a)*b8;++a2){y=$.$get$bU()
a3=y.a9()
a4=y.a9()
a5=u+a3*p
a6=t+a3*m
o=this.b
l=F.fl(a1[0],a1[1],a1[2],1)
k=b8*(0.5+y.a9())
j=y.a9()
j=H.d([new F.Y(a5+a4*(s+a3*h-a5),a6+a4*(q+a3*n-a6)),new G.h_(),l,new G.c1(k,k),new G.b_(g+y.a9()*3.141592653589793/32,e+j*0.2,0),new F.aD(c),new F.bQ("propulsion",1,0.2,0,0.0125,!0),new G.ah(b8*b0.a/10)],r)
a7=o.a.bV()
C.a.q(j,a7.gc_())
o.c.l(0,a7)}}},tB:{"^":"vn;0fx,0fy,0go,0id,a,0b,c,d,e,f,0r,0x,0y",
a2:[function(a){var z,y,x,w,v,u,t,s,r,q
z=this.fy.b
y=a.a
x=z.a[y]
